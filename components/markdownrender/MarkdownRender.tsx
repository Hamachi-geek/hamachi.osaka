...
function HtmlElementRender({ element }: HtmlElementRenderProps) {
    ...
    switch (tagName) {
        ...
        case "code":
            return <code className="px-2 font-(family-name:--line-seed) rounded-md text-content-text-light dark:text-content-text-dark bg-gray-200 dark:bg-gray-800">{childrenHtml}</code>
