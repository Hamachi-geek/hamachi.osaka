...
type PortfolioOtherContainerProps = {
    /** 表示するデータ */
    portfolioDataListWithoutCurrentSelect: PortfolioData[]
    /** くわしく押したとき */
...
export default function PortfolioDeck({ portfolioDataListWithoutCurrentSelect, onMoreClick }: PortfolioOtherContainerProps) {
    return (
        <div className="flex flex-col">
            ...
            <div className="flex flex-row py-2 space-x-4 overflow-x-scroll">
                {
                    portfolioDataListWithoutCurrentSelect.map((portfolioData) => (
